...
class ArgumentPanel : public wxPanel
{
  ...
  public:
    ...
    ArgumentPanel(wxWindow *parent, wxWindowID id = wxID_ANY, const wxPoint &pos = wxDefaultPosition,
                  const wxSize &size = wxSize(-1, -1), long style = wxBORDER_THEME);
    ArgumentPanel(wxWindow *parent, dgArgument function, wxWindowID id = wxID_ANY,
