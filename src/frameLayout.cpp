...
frameLayout::frameLayout(wxWindow *parent, wxWindowID id, const wxString &title, const wxPoint &pos, const wxSize &size,
                         long style)
    : wxFrame(parent, id, title, pos, size, style)
{
    ...
    sourceMenuItem =
        new wxMenuItem(aboutMenu, wxID_ANY, wxString(wxT("Factual sources")), wxEmptyString, wxITEM_NORMAL);
    ...
    classesText =
        new wxStaticText(controlWindow, wxID_ANY, wxT("Classes"), wxDefaultPosition, wxDefaultSize, wxALIGN_CENTRE);
    classesText->Wrap(-1);
    ...
    membersText =
        new wxStaticText(controlWindow, wxID_ANY, wxT("Members"), wxDefaultPosition, wxDefaultSize, wxALIGN_CENTRE);
    membersText->Wrap(-1);
    ...
    functionButton =
        new wxToggleButton(controlWindow, wxID_ANY, wxT("Member function"), wxDefaultPosition, wxDefaultSize, 0);
    ...
    relationshipsText = new wxStaticText(controlWindow, wxID_ANY, wxT("Relationships"), wxDefaultPosition,
                                         wxDefaultSize, wxALIGN_CENTRE);
    relationshipsText->Wrap(-1);
    controlSizer->Add(relationshipsText, 0, wxALL | wxEXPAND, 5);

    inheritanceButton =
        new wxToggleButton(controlWindow, wxID_ANY, wxT("Inheritance"), wxDefaultPosition, wxDefaultSize, 0);
    controlSizer->Add(inheritanceButton, 0, wxALL | wxEXPAND, 5);

    friendshipButton =
        new wxToggleButton(controlWindow, wxID_ANY, wxT("Friendship"), wxDefaultPosition, wxDefaultSize, 0);
    ...
    this->Connect(openMenuItem->GetId(), wxEVT_COMMAND_MENU_SELECTED,
                  wxCommandEventHandler(frameLayout::OnOpenSelected));
    this->Connect(saveMenuItem->GetId(), wxEVT_COMMAND_MENU_SELECTED,
                  wxCommandEventHandler(frameLayout::OnSaveSelected));
    this->Connect(exportMenuItem->GetId(), wxEVT_COMMAND_MENU_SELECTED,
                  wxCommandEventHandler(frameLayout::OnExportSelected));
    this->Connect(authorMenuItem->GetId(), wxEVT_COMMAND_MENU_SELECTED,
                  wxCommandEventHandler(frameLayout::OnAuthorSelected));
    this->Connect(sourceMenuItem->GetId(), wxEVT_COMMAND_MENU_SELECTED,
                  wxCommandEventHandler(frameLayout::OnSourceSelected));
    classButton->Connect(wxEVT_COMMAND_TOGGLEBUTTON_CLICKED, wxCommandEventHandler(frameLayout::OnClassToggled), NULL,
                         this);
    dataButton->Connect(wxEVT_COMMAND_TOGGLEBUTTON_CLICKED, wxCommandEventHandler(frameLayout::OnDataToggled), NULL,
                        this);
    functionButton->Connect(wxEVT_COMMAND_TOGGLEBUTTON_CLICKED, wxCommandEventHandler(frameLayout::OnFunctionToggled),
                            NULL, this);
    inheritanceButton->Connect(wxEVT_COMMAND_TOGGLEBUTTON_CLICKED,
                               wxCommandEventHandler(frameLayout::OnInheritanceToggled), NULL, this);
    friendshipButton->Connect(wxEVT_COMMAND_TOGGLEBUTTON_CLICKED,
                              wxCommandEventHandler(frameLayout::OnFriendshipToggled), NULL, this);
    nestingButton->Connect(wxEVT_COMMAND_TOGGLEBUTTON_CLICKED, wxCommandEventHandler(frameLayout::OnNestingToggled),
                           NULL, this);
}
...
frameLayout::~frameLayout()
{
    ...
    classButton->Disconnect(wxEVT_COMMAND_TOGGLEBUTTON_CLICKED, wxCommandEventHandler(frameLayout::OnClassToggled),
                            NULL, this);
    dataButton->Disconnect(wxEVT_COMMAND_TOGGLEBUTTON_CLICKED, wxCommandEventHandler(frameLayout::OnDataToggled), NULL,
                           this);
    functionButton->Disconnect(wxEVT_COMMAND_TOGGLEBUTTON_CLICKED,
                               wxCommandEventHandler(frameLayout::OnFunctionToggled), NULL, this);
    inheritanceButton->Disconnect(wxEVT_COMMAND_TOGGLEBUTTON_CLICKED,
                                  wxCommandEventHandler(frameLayout::OnInheritanceToggled), NULL, this);
    friendshipButton->Disconnect(wxEVT_COMMAND_TOGGLEBUTTON_CLICKED,
                                 wxCommandEventHandler(frameLayout::OnFriendshipToggled), NULL, this);
    nestingButton->Disconnect(wxEVT_COMMAND_TOGGLEBUTTON_CLICKED, wxCommandEventHandler(frameLayout::OnNestingToggled),
                              NULL, this);
}
