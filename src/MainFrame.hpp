...
{
    vector<wxToggleButton *> buttons{classButton,       dataButton,       functionButton,
                                     inheritanceButton, friendshipButton, nestingButton};
  ...
  public:
    MainFrame(wxWindow *parent, wxWindowID id = wxID_ANY, const wxString &title = wxT("Class Designer"),
              const wxPoint &pos = wxDefaultPosition, const wxSize &size = wxSize(978, 465),
