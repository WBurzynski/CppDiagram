...
class FunctionDialogLayout : public wxDialog 
{
	...
	protected:
		...
		virtual void OnModifierPicked( wxCommandEvent& event ) { event.Skip(); }
		virtual void OnVisibilityPicked( wxCommandEvent& event ) { event.Skip(); }
	...
	public:
		...
		FunctionDialogLayout( wxWindow* parent, wxWindowID id = wxID_ANY, const wxString& title = wxEmptyString, const wxPoint& pos = wxDefaultPosition, const wxSize& size = wxDefaultSize, long style = wxDEFAULT_DIALOG_STYLE ); 
