...
MemberDialog::MemberDialog(wxWindow *parent, wxWindowID id, const wxString &title, const wxPoint &pos,
    ...
    : wxDialog(parent, id, title, pos, size, style)
{
    ...
    // Connect Events
    ModifierBox->Connect(wxEVT_COMMAND_RADIOBOX_SELECTED, wxCommandEventHandler(MemberDialog::OnModifierPicked), NULL,
                         this);
    VisibilityBox->Connect(wxEVT_COMMAND_RADIOBOX_SELECTED, wxCommandEventHandler(MemberDialog::OnVisibilityPicked),
                           NULL, this);
...
{
    // Disconnect Events
    ModifierBox->Disconnect(wxEVT_COMMAND_RADIOBOX_SELECTED, wxCommandEventHandler(MemberDialog::OnModifierPicked),
                            NULL, this);
    VisibilityBox->Disconnect(wxEVT_COMMAND_RADIOBOX_SELECTED, wxCommandEventHandler(MemberDialog::OnVisibilityPicked),
                              NULL, this);
    m_sdbSizer3Cancel->Disconnect(wxEVT_COMMAND_BUTTON_CLICKED, wxCommandEventHandler(MemberDialog::OnCancel), NULL,
                                  this);
