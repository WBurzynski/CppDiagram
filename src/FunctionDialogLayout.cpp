...
FunctionDialogLayout::FunctionDialogLayout( wxWindow* parent, wxWindowID id, const wxString& title, const wxPoint& pos, const wxSize& size, long style ) : wxDialog( parent, id, title, pos, size, style )
{
	...
	DescriptionText = new wxStaticText( this, wxID_ANY, wxT("Insert member function info:"), wxDefaultPosition, wxDefaultSize, 0 );
	...
	ArgumentsWindow = new wxScrolledWindow( this, wxID_ANY, wxDefaultPosition, wxDefaultSize, wxALWAYS_SHOW_SB|wxVSCROLL );
	...
	// Connect Events
	ModifierBox->Connect( wxEVT_COMMAND_RADIOBOX_SELECTED, wxCommandEventHandler( FunctionDialogLayout::OnModifierPicked ), NULL, this );
	VisibilityBox->Connect( wxEVT_COMMAND_RADIOBOX_SELECTED, wxCommandEventHandler( FunctionDialogLayout::OnVisibilityPicked ), NULL, this );
	AddButton->Connect( wxEVT_COMMAND_BUTTON_CLICKED, wxCommandEventHandler( FunctionDialogLayout::OnAddClicked ), NULL, this );
	RemoveButton->Connect( wxEVT_COMMAND_BUTTON_CLICKED, wxCommandEventHandler( FunctionDialogLayout::OnRemoveClick ), NULL, this );
	m_sdbSizer1Cancel->Connect( wxEVT_COMMAND_BUTTON_CLICKED, wxCommandEventHandler( FunctionDialogLayout::OnCancel ), NULL, this );
...
{
	// Disconnect Events
	ModifierBox->Disconnect( wxEVT_COMMAND_RADIOBOX_SELECTED, wxCommandEventHandler( FunctionDialogLayout::OnModifierPicked ), NULL, this );
	VisibilityBox->Disconnect( wxEVT_COMMAND_RADIOBOX_SELECTED, wxCommandEventHandler( FunctionDialogLayout::OnVisibilityPicked ), NULL, this );
	AddButton->Disconnect( wxEVT_COMMAND_BUTTON_CLICKED, wxCommandEventHandler( FunctionDialogLayout::OnAddClicked ), NULL, this );
	RemoveButton->Disconnect( wxEVT_COMMAND_BUTTON_CLICKED, wxCommandEventHandler( FunctionDialogLayout::OnRemoveClick ), NULL, this );
	m_sdbSizer1Cancel->Disconnect( wxEVT_COMMAND_BUTTON_CLICKED, wxCommandEventHandler( FunctionDialogLayout::OnCancel ), NULL, this );
	m_sdbSizer1OK->Disconnect( wxEVT_COMMAND_BUTTON_CLICKED, wxCommandEventHandler( FunctionDialogLayout::OnOK ), NULL, this );
